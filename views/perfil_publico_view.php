            ...
            <div id="2latiendaboton" class="grid_8 flex_perfil_paramenu"  style="width: 80.6666667%;position: relative; <?php if(!isset($_GET['id_producto'])){ echo 'display: flex;';}else echo 'display: none;';?>; flex-direction: row;">
                <div class="grid_12" id="grid_12_contenedor_perfil">
                    ...
                    <div id='sidenavs' class='grid_4 menu_rapido_perfil' style="box-sizing: border-box;">
                        ...
                        <div class="grid_10 menu_rapido_perfil " id="mySidenavmensajeria"  style="height: 400px; display: none;  ">
                            <div id="mySidenavmensajeria_buzon"  style="height:400px; display: block">
                                <div class="caja_mensajeria">
                                    <div class="caja_mensajeria_pestañas">
                                        <div style="height:60px;align-items:center;" class="primera-pestaña_mensajeria">
                                            <p>Para presupuestos y consultas</p>
                                        </div>
                                    </div>
                                    <form style="pading-top:0px;" class="edit" id='enviar_mensaje_tienda' id_tienda='<?php echo $id_tienda;?>' method="post" name="form1" >
                                        <fieldset>
                                            <label class="name">
                                                <input type="email" id="correo_perfil_publico" class="editar" name="correo"  value="" required style="font-family: 'Montserrat', sans-serif;font-weight:normal;width:100%;font-size:14px;" title="Correo" placeholder="Su Correo por favor"/>
                                            </label>
                                        </fieldset>
                                        <br/>
                                        <fieldset>
                                            <label class="name">
                                                <input type="text" id="correo_asunto_perfil_publico" class="editar" name="asunto"  value="" required style="font-family: 'Montserrat', sans-serif;font-weight:normal;width:100%;font-size:14px;" title="Correo" placeholder="Asunto"/>
                                            </label>
                                        </fieldset>
                                        <br/>
                                        <fieldset>
                                            <label class="name cuadro_enviar_mensaje_a_tienda">
                                                <textarea  name="mensaje" placeholder="Describa su necesidad" style="width:92%; text-align:justify; max-height:210px" class="mensaje" required ></textarea>
                                                <label style="width:100%; width:100%; display: flex;justify-content: flex-end;flex-direction: column; align-items: flex-end;">
                                                    <input type="file" name="archivo" id="archivo" placeholder=""  size="30" style="display:none" >
                                                    <img src="../../../../../../../img/Mensajeria o chat copia-04.svg" style="width:50px;cursor:pointer" >
                                                </label>
                                            </label>
                                            <input class="boton" name="" type="submit" value="Enviar" style="margin-bottom:5px;margin-top: 10px;border-radius: 20px;" >
                                        </fieldset>
                                        <input type="hidden" name="MM_update" value="form2" />
                                        <input type="hidden" name="id_tienda" value="<?php echo $id_tienda; ?>" />
                                        <input name="correotienda" type="hidden" value="<?php echo $correotienda; ?>">
