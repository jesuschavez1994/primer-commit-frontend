...
<link href="https://file.myfontastic.com/SQY7bBTxyFP89VqNjUyFL8/icons.css?1.2.0650271" rel="stylesheet">
<link rel="stylesheet" href="../../../../../../../css/Estilos_buscador_de_productos.css?<?php echo $version; ?>">
...
<body>
  ...
  <div class="container">
    <div class="row" >
      <div class="two columns" id="contenedor_filtro_buscador_producto"style="display: flex;flex-direction: column; justify-content: center;align-items: center;padding-top:20px" >
        <?php
        include('controllers/totalizador_buscandoelproducto.php');
        ?>
      </div>
      <div class="ten columns buscador_tienda_producto" >
        <div id="campo" style="margin-left:0%;width:100%">
...
<script>
  ...
  function load(page){
    ...
    var categoria=<?php echo $id_categoria_s ?>;
    ...
    var parametros = {
      "action":"ajax",
      "page":page,
      "producto":producto_buscador_panel,
      "id_ciudad":ciudad,
      "arr_id_estado":JSON.stringify(arr_id_estado),
      "arr_id_categoria":JSON.stringify(arr_id_categoria),
      "producto_or_servicio":producto_or_servicio
    };
    $("#loader").fadeIn('slow');
    $.ajax({
      url:"../../../../../../../controllers/buscandoelproducto.php",
      data: parametros,
    ...
    boton_aplicar_filtros.addEventListener("click",function() {
      ...
      $.ajax({
      url:"../../../../../../../controllers/totalizador_buscandoelproducto.php",
      data: parametros,
       beforeSend: function(objeto){
      },
      success:function(data){
