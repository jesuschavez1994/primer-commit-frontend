...
if ($total>0){
  for ($i = 0; $i < $total; $i++){
    ?>  
<div class="grid_2_perfil omega contenedor3 entrada_imagen" title="<?php echo $productos[$i]; ?>"> 
  <div class="grid_12perfil2">
      <div  class="boxp1" style="  font-size:11px; " >
        ...
        <div class="middle7" style="width:100%">
          <button id="eliminar_<?php echo $id_productos[$i]; ?>" id_producto="<?php echo $id_productos[$i]; ?>" id_tienda="<?php echo $id_tienda; ?>" id_contacto="<?php echo $id_contacto; ?>"  class="eliminar_productos_perfil texto_boton_imagen7" botonactual="misproductos" nombre_imagen_producto='<?php echo $nombre_imagen_producto[$i];?>'>
          <img src="../../../../../../../img/papelera pequena-01.svg" style="width:100%;z-index:10;">
          </button>
        </div>
        <div class="middle3" style="width:100%">
        ...
        <div class="middle4" style="width:100%" >
        ...
        <div class="middle6" style="width:100%" >
        ...
        <div class="demo-content2" style="width:100%;clear: left" >
          <img class="grid_img_1 image3" src="../../../../../../../img/Caja 1000x1000_Mesa de trabajo 1 copia.svg" data-src="../../../../../../../contactos/contacto<?php echo $id_contacto; ?>/<?php echo $nombre_imagen_producto[$i]; echo $id_productos[$i]; ?>/<?php echo $nombre_imagen_producto[$i];?>g1_<?php echo $id_productos[$i]; ?>.jpeg?<?php echo $version_imagen_producto_arr[$i]; ?>" 
  ...
  <?php 
    ...
    ?>
    <div class="nohay" >
      <p> Tu búsqueda <span>"<?php echo $producto?>"</span>no coincide con ningún producto o servicio de tu tienda</p>
      <p>TE RECOMENDAMOS</p>
      <br>
...
$('.eliminar_productos_perfil').click(function(){
    var id_producto = $(this).attr('id_producto');
    var tipo = "eliminador";
    var id_tienda = $(this).attr('id_tienda');
    var id_contacto = $(this).attr('id_contacto');
    ...
    $("#1misproductos").load("../../../../../../../controllers/buscando_producto_eliminar.php?tipo="+tipo+"&id_producto="+id_producto+"&id_contacto="+id_contacto+"&id_tienda="+id_tienda+"&nombre_imagen_producto="+nombre_imagen_producto);
    $("#2misproductos").load("../../../../../../../buscandoproductoimgeditar.php?tipo="+tipo+"&id_producto="+id_producto+"&id_contacto="+id_contacto+"&id_tienda="+id_tienda);
});
