...
<title>Founduss Terminos y Condiciones</title>
...
<link rel="stylesheet" href="../../../../../../../css/terminosycondiciones.css?<?php echo $version; ?>">
<link href="https://fonts.googleapis.com/css?family=Libre+Franklin:500|Oxygen" rel="stylesheet">
...
<body>
  ...
  <div class="container "  >
    <div class="row">
      <div class="twelve columns terminoscondiciones" style=" width:75%;border-color: rgba(61,61, 63,0.5);margin-left: 12.5%;margin-right: 12.5%; margin-top: 60px">
        <h1>FOUNDUSS</h1>
        <br>
        <p>
        ...
        <br>
        <p>
          Para efectos de la inscripción, es obligatorio completar el formato de inscripción en cada uno de los espacios asignados para ello, completando con datos válidos para poder hacer uso de los servicios e información que presta o forma parte del contenido del Portal Web FOUNDUSS. En la suscripción del usuario al Portal Web, debe completarse el formato de inscripción con datos e información personal y/o de empresa de manera exacta, precisa y verdadera, asumiendo la responsabilidad de actualizar de manera permanente los datos e información en un todo de acuerdo a las necesidades o requerimientos del Portal Web. 
        </p>
        <br>
        <p>
        ...
        <p>
          Para la Certificación en el Nivel 2, el ofertante podrá incorporar solo veinte (20) ítems en el inventario de sus productos, bienes y servicios ilimitados por un año, mayor prioridad, posicionamiento y búsqueda de tiendas por encima del Nivel 1. El costo del servicio para acceder a esta certificación, será indicado por los ejecutivos de FOUNDUSS, C.A. en visita a la Tienda, Negocio o empresa para su respectivo pago, además le otorgará por medio impreso al ofertante la Certificación obtenida.
        </p>
        <br>
        <p>
          La Certificación en el Nivel 3 a los usuarios en calidad de ofertantes, les permite la Certificación por un (1) año, previamente debió haber obtenido la Certificación en el Nivel 2, tendrá mayor prioridad, posicionamiento y búsqueda de tiendas por encima del Nivel 1 y Nivel 2. Son Tiendas con la categoría para ser visitados por personal de FOUNDUSS, C.A.
        </p>
        <p>
        ...
        <br>
        <p>
          El costo del servicio para acceder a esta certificación, será indicado por los ejecutivos de FOUNDUSS, C.A. en visita a la Tienda, para su respectivo pago, además le otorgará por medio impreso al ofertante la Certificación obtenida.
        </p>
        <br>
        <h2>
